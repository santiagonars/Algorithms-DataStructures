...
def main():
    print(search_floor_of_a_number([4, 6, 10], 6)) # expected output = 1
    print(search_floor_of_a_number([1, 3, 8, 10, 15], 12)) # expected output = 3 
    print(search_floor_of_a_number([4, 6, 10], 17)) # expected output = 2
    print(search_floor_of_a_number([4, 6, 10], -1)) # expected output = -1
